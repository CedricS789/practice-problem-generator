...
- Opens the full Quick practice workspace in a main tab by default so source review, occlusion editing, and study have enough width. A Right sidebar setting remains available for users who prefer a compact layout; the dashboard and guided-learning builder always use dedicated main tabs.
